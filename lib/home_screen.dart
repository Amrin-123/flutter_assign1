...
class HomeScreen extends StatelessWidget {
  final List<Map<String, String>> plants = [
    {'name': 'Sunflower', 'price': '\$12', 'image': 'assets/sunflower.webp'},
    {'name': 'Lily', 'price': '\$18', 'image': 'assets/lily.webp'},
    {'name': 'Sunflower', 'price': '\$12', 'image': 'assets/sunflower.webp'},
    {'name': 'Lily', 'price': '\$18', 'image': 'assets/lily.webp'},
    {'name': 'Sunflower', 'price': '\$12', 'image': 'assets/sunflower.webp'},
    {'name': 'Lily', 'price': '\$18', 'image': 'assets/lily.webp'},
...
class CategoryChip extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Chip(label: Text(label), backgroundColor: Colors.green.shade50);
  }
}
